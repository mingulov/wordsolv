...
export const ru: Record<MsgKey, string> = {
  ...
  'semantic.title': 'Семантический решатель',
  'semantic.wordLabel': 'Слово',
  'semantic.rankLabel': 'Номер',
  'semantic.add': 'Добавить',
  'semantic.notFound': 'Не найдено',
  'semantic.guesses': 'Попытки',
  'semantic.rejected': 'Отклонено сайтом',
  'semantic.suggestions': 'Подсказки',
  'semantic.exploreHint': 'Разведка — эти слова прощупывают разные смысловые области.',
  'semantic.exploitHint': 'Сужаем круг — эти слова уточняют вокруг лучшего номера.',
  'semantic.solved': 'Решено!',
